...
Pending — generate the same expanded prompt on ChatGPT Images, Gemini, and Grok, then drop files in `examples/explodedview/` and date this section. Do not mark a model as working until then.
