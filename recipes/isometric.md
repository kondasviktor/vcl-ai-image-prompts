...
Pending — generate the same expanded prompt on ChatGPT Images, Gemini, Grok, and MAI Playground (MAI-Image), then drop files in `examples/isometric/` and date this section. Do not mark a model as working until then.
